...
test('should first', async () => {
  ...
  // const user = userEvent.setup();setupで状態を1つのインスタンスに同居させることができる。例えばctrlをkeybord()で押下しながらある要素をclick()することができる
  await userEvent.click(button); // 再描画されたボタンを取得 取得には正規表現も使えます。
